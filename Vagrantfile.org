...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  ansible-pull -i inventory -U https://github.com/praveensams/all_ansible  suren.yml -e 'host_name=localhost, playbooks=haproxy'
  SHELL
  end
  ...
  config.vm.define :web1 do |web1_config|
	...
	yum install ansible git -y
  ansible-pull -i inventory -U https://github.com/praveensams/all_ansible  suren.yml -e 'host_name=localhost , playbooks=apache'
